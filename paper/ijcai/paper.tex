...
test is perfomed for all techniques and its variants. With $99\%$ of
confidence, the results tell us that the distributions are not
normal. Given that $C$ is not normally distributed, we use Friedman, a
non-parametric statistical test of hypothesis. The null hypothesis is
that the ranking results of all techniques and variants are the
...
$115$ faults for $k=10$. \Mar{Sofia, acho mais apropriado colocar isto
  em conclusions}These are promissing results from what Automated
