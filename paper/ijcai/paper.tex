...
only 9\%\comments{(23 misses)} of the 260 cases\Mar{we are using
  \numFaults{} in the paper. please, revise and use macros.} and that
the \ds{}-\sfl{} combination, coined as Tandem-SL, improves on average
the diagnostic accuracy by \Fix{Z} in 51\% of the cases. To sum, we
...
\Mar{move this elsewhere...}
\Fix{
with the
goal of demystifying the impact of combining \ds{} with \sfl{}.  
  
Despite tacit negative opinions of the research
community about the usefulness of \ds{} in automated debugging,}
