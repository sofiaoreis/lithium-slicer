...
\begin{abstract}
  The task of locating faulty code from failing testing is a very
  important problem known as software fault localization. This paper
  reports on a comprehensive study to reassess the impact of combining
  two very popular techniques to that end--Dynamic Slicing and
  Spectrum-based Fault Localization. Our results show that \Fix{...}
\end{abstract}
