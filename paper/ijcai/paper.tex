...
\numFaults{}\Mar{check} faults from \numPrograms{}\Mar{check}
...
slicing process.\comments{ We evaluated how often that issue manifests
  in our experiments.} The second research question evaluates the
