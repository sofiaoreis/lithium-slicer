...
purpose~\cite{Pearson:2017:EIF:3097368.3097441,just-defects4j-issta2014}. 
A fault of omission occurs when
...
produce accurate diagnostic reports in those cases is poor since fault of omission
...
\begin{figure}[h]
		\centering
		\includegraphics[width=0.47\textwidth]{figures/double-boxplot.pdf}
		\caption{Boxplot of $\Delta{}C$.}
		\label{fig:boxplot}
\end{figure}
%
% \begin{figure}[h]
