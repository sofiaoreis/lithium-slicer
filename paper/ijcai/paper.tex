...
\begin{abstract}
Several approaches have been proposed to improve automated software fault
diagnosis, aiming to reduce the effort and costs spent in debugging. This
paper reports the outcome of a study
performed to dismistify\Rui{We need to say something on why we
...
suspect that several highly suspiscious components --- often involved in failing, 
but seldom in passed executions ---
...
results show that combining SFL with dynamic slicing improves the diagnostic
accuracy in \Rui{x\% on average}, hence leading to the root cause of observed failures faster.
\end{abstract}
