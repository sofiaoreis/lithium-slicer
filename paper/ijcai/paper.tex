...
\begin{table*}[h]
	\centering
	  \begin{tabular}{|l|ccc|cccc|c|}
		\toprule
		\multirow{2}{*}{Project}            & \multicolumn{3}{c|}{SFL}  & \multicolumn{4}{c|}{\comb{}-$k$} & \multirow{2}{*}{\# Faults} \\
		...
		\bottomrule
	\end{tabular}
  \caption {Number of faults where at least one of the buggy-lines is in the SFL and \comb{}-$k$ report \Sof{@todo: Add absolute numbers for SFL}}
  \label{table:fsws}
\end{table*}
