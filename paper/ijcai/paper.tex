...
\Mar{sofia,
  ...
  distibution (as per the base of the plot) seems to be 0.}\Sof{Yes, check hangouts} To sum,
...
all techniques and both $k$s. With $99\%$ of confidence, the
...
ranking results of all techniques for each $k$ are the same. With
