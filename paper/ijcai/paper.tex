...
combination consists of four steps:\Sof{Should we specify that these steps are
performed for each version of the projects/defect?}
\begin{enumerate}
  \itemsep0em 
