...
diagnosis, aiming to reduce the effort and costs spent in debugging. 
Dynamic Slicing (\ds{}) and Spectrum-based Fault Localization (\sfl{}) are very popular techniques and normally seen as complementary. However, this combination has not been entirely explored yet.
Thus, this paper reports the outcome of an empirical study
performed to demystify the impact of combining \ds{} with \sfl{}, a technique we coin as Tandem-FL. 
We
suspect that several highly suspicious components --- often involved in failing, 
but seldom in passed executions ---
may be unrelated to the bug. 
