...
statements,  since it is one of the main issues of dynamic slicing techniques.
This is particularly important because when \ds{} missing a faulty statement
...
of the highest faulty  classes. \combpar{k} finds the faulty statements faster
than  \sfl{}$^{k}$. \Rui{Starting from here, I don't see the connection with
the rq... the rq has nothing to do with the combination. We need to somehow
motivate why we are discussing these numbers here.}
...
$33$ of the $260$ \Rui{Ehmm... is this in sycn with previous section?}
...
\Rui{APR doesn't belong here, maybe the last thing to discuss in this section,
but not here in the middle}
It is worth noting that Automated
Program Repair techniques may directly benefit from this study to improve their
results. Figure \ref{fig:diagnosis} reports the performance of the diagnosis
...
distributions are distinct. To understand if there exist a pair of
distributions that are equal \Rui{equal? isn't this test the effect size?}, we performed a Siegel post-hoc analysis. Figure
