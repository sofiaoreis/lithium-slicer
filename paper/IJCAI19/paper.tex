...
Sofia Reis$^{1,2}$
\and
Rui Abreu$^{1,2}$ \textnormal{and}
Marcelo d'Amorim$^3$\affiliations
...
% elsewhere\footnote{Lithium complexity available at \mbox{https://github.com/MozillaSecurity/lithium/blob/master/src/lithium/docs/algorithm.md}
% (Accessed \today)}.
